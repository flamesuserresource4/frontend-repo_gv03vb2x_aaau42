      ...
      <div className="max-w-6xl mx-auto px-6 py-8 space-y-8">
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-50">Private Dashboard</h3>
            {isAuthed && (
              <button
                onClick={() => {
                ...
                className="text-xs px-3 py-1 rounded-lg bg-white/5 text-slate-900 dark:text-white ring-1 ring-white/10 hover:bg-white/10"
              >
                Sign out
              </button>
            )}
